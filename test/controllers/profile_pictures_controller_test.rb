...
class ProfilePicturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create profile_picture" do
    assert_difference("ProfilePicture.count") do
      post profile_pictures_url, params: { profile_picture: { image: @profile_picture.image, profile_id: @profile_picture.profile_id } }
    end
  ...
  test "should update profile_picture" do
    patch profile_picture_url(@profile_picture), params: { profile_picture: { image: @profile_picture.image, profile_id: @profile_picture.profile_id } }
